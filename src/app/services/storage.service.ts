...
//     this.cookieService.set('token', token, { expires: 7, domain: domain });
//     this.cookieService.set('refreshToken', refreshToken, { expires: 7, domain: domain});
//     this.cookieService.set('quyen', quyen, { expires: 7, domain: domain });
//     this.cookieService.set('tenTaiKhoan', tenTaiKhoan,{ expires: 7, domain: domain });
//     this.cookieService.set('ngayHetHan', ngayHetHan.toString(), { expires: 7, domain: domain}); // Lưu thời gian hết hạn
//   }
